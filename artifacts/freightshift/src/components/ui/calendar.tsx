  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_middle: cn("rounded-xl", defaultClassNames.range_middle),
        range_end: cn("bg-primary rounded-r-md", defaultClassNames.range_end),
        today: cn(
          "bg-primary text-primary-foreground rounded-md data-[selected=true]:rounded-xl",

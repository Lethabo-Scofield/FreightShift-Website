      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-sm text-foreground/70 max-w-xs font-mono">
            ...
            <ul className="flex flex-col gap-4">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-sm font-mono font-bold uppercase tracking-wider text-foreground hover:text-accent transition-colors flex items-center gap-2 group"
                  >
              ...
              <li>
                <button
                  ...
                  className="text-sm font-mono font-bold uppercase tracking-wider text-foreground hover:text-accent transition-colors flex items-center gap-2 group text-left"
                >
                  <ArrowUpRight className="w-4 h-4 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all" />
                  Get a Quote
                </button>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li className="text-sm font-mono uppercase tracking-wider text-foreground/70">Freight Forwarding</li>
              <li className="text-sm font-mono uppercase tracking-wider text-foreground/70">Customs Clearance</li>
              <li className="text-sm font-mono uppercase tracking-wider text-foreground/70">Warehousing</li>
              <li className="text-sm font-mono uppercase tracking-wider text-foreground/70">China-SA Corridor</li>
            </ul>
          </div>
        </div>

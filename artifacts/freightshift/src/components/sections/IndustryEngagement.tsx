...
export function IndustryEngagement() {
  return (
    <section className="py-20 md:py-32 bg-background border-b border-border relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground mb-8 tracking-tight leading-[0.9]">
              Industry <br />
              Engagement.
            </h2>
            
            <blockquote className="text-xl md:text-2xl text-foreground/80 leading-relaxed font-sans border-l-4 border-primary pl-6 py-2 bg-foreground/5 relative">
              <div className="absolute top-2 -left-[3px] w-1.5 h-6 bg-primary" />
          ...
          >
            <div className="col-span-3 row-span-5 border border-border bg-foreground overflow-hidden relative group">
              <img
                src={ujVisit1}
            ...
            <div className="col-span-2 row-span-5 border border-border bg-foreground overflow-hidden relative group">
              <img
                src={ujVisit2}
